  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <PaymentForm cart_id={this.props.cart_id} user_id={this.props.user_id} minimum_payment={cart.state.data.custom_minimum_payment} remaining_balance={cart.state.data.remaining_balance} />
